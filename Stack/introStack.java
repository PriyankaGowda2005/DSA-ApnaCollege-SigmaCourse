...
public class introStack {
    public static void main(String[] args) {
        System.out.println("This is an introduction to Stack data structure.\n");
        ...
        // --------------------------
        System.out.println("Popped element: " + stack.pop()); // 30 removed
...
/*
 * This is an introduction to Stack data structure.
 * 
